...
stopWords = []
st = open(r'D:\project\stopWord_list.txt', 'r')
stopWords = getStopWordList(r'D:\project\stopWord_list.txt')


#Read the tweets one by one and process it
wb = xlrd.open_workbook(r'D:\project\datasets\lenovoK3\Training2.xlsx')
...
wb1 = xlrd.open_workbook(r'D:\project\datasets\lenovoK3\Test2.xlsx')
